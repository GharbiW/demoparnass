...
const useRole = () => ({ role: 'fleet_manager' }); // Change to 'hr' to see unmasked data
    ...
    <div className="flex flex-col gap-6">
      ...
      <main className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start">
        ...
        <div className="col-span-1 flex flex-col gap-6">
            <Card>
                <CardHeader><CardTitle>Profil & Conformité</CardTitle></CardHeader>
                 ...
                 <CardContent className="space-y-4">
                     {role === 'driver' ? (
                        <div className="text-center">
                            <p>Niveau de risque global: <Badge variant="secondary">Moyen</Badge></p>
                        </div>
                     ) : (
        ...
        {/* Row 2 */}
        <div className="col-span-1 xl:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
                 <CardHeader>
             ...
             <Card>
                 <CardHeader>
                    <CardTitle>Formations & Tâches</CardTitle>
                </CardHeader>
                 <CardContent>
                     <h4 className="text-md font-semibold mb-2">Formations Assignées</h4>
                     <div className="space-y-2">
                      ...
                      <Button size="sm" className="mt-4" onClick={() => setAssignTrainingOpen(true)}>Assigner une formation</Button>
                      <Separator className="my-4"/>
                       <h4 className="text-md font-semibold mb-2">Tâches de Coaching</h4>
